import { Controller, Get, Post, Put, Param, Body, Req, Res, UseGuards, HttpException, HttpStatus } from '@nestjs/common';
...
export class OrganizationController {
  ...
  async inviteUser(
    ...
    if (user.role !== 'ADMIN') throw new HttpException('Unauthorized', HttpStatus.FORBIDDEN);
